...
export class MapUser1716144899128 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "images_product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "url" character varying(255) NOT NULL, "description" character varying(255) NOT NULL, "productId" uuid, CONSTRAINT "PK_96fabbb1202770b8e6a58bf6f1d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "infos_product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "description" character varying(255) NOT NULL, "productId" uuid, CONSTRAINT "PK_553d59266afcb5da4f0cbc622c4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "images_product" ADD CONSTRAINT "FK_589324bf6091e1406de46b50905" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "infos_product" ADD CONSTRAINT "FK_2b5c05dfd557a5972105ca4df9a" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "infos_product" DROP CONSTRAINT "FK_2b5c05dfd557a5972105ca4df9a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "images_product" DROP CONSTRAINT "FK_589324bf6091e1406de46b50905"`,
    );
    await queryRunner.query(
